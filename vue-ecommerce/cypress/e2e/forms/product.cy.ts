describe('Product Crud Test', () => {
 ...
 it('Read a product Using edit mode', () => {
  ...
  it('Read a product Using Display mode', () => {
    ...
    cy.get('#displayProductElement1key').should('contain','Name')
    cy.get('#displayProductElement1value').should('contain','Simple Watch')

    cy.get('#displayProductElement2key').should('contain','Description')
    cy.get('#displayProductElement2value').should('contain','Embrace timeless sophistication with the Simple Watch, a fusion of classic design and modern functionality. Crafted from stainless steel and sapphire crystal.')

    cy.get('#displayProductElement4key').should('contain','Image url')
    cy.get('#displayProductElement4value').should('contain','watch.jpeg')

    cy.get('#displayProductElement3key').should('contain','Price')
    cy.get('#displayProductElement3value').should('contain','65')

    cy.get('#displayProductElement6key').should('contain','Category')
    cy.get('#displayProductElement6value').should('contain','Accessories')
    ...
    cy.get('#displayProductElement7key').should('contain','Currency')
    cy.get('#displayProductElement7value').should('contain','€')
