describe('Product Form Test', () => {
    ...
    it('Submit puting data in wrong format', () => {
        ...
        cy.get('#inputNumber-Price').should('have.css', 'background-color', 'rgb(254, 202, 202)').parent().should('contain', 'Set the correct format');
        ...
        cy.get('#inputNumber-Price').type('1,3').should('have.css', 'background-color', 'rgb(249, 250, 251)').parent().should('not.contain', 'Set the correct format');
